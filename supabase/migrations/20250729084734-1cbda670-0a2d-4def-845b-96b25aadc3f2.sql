...
BEGIN
  INSERT INTO user_activity_log (
    ...
    user_uuid, action_name, resource_type_param, resource_id_param, metadata_param
  );
END;
$$;
...
-- Update restaurants table to work with new user system
...
UPDATE restaurants SET user_id = id WHERE user_id IS NULL;
