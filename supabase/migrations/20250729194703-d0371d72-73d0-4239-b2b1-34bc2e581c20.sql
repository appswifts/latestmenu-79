...
DROP POLICY IF EXISTS "Restaurant owners can manage their menu groups" ON public.menu_groups;
...
DROP POLICY IF EXISTS "Anonymous users can view menu groups for active restaurants" ON public.menu_groups;
...
DROP POLICY IF EXISTS "Users can manage menu items for their restaurants" ON public.menu_items;
DROP POLICY IF EXISTS "Users can manage menu categories for their restaurants" ON public.menu_categories;
...
DROP POLICY IF EXISTS "Users can manage tables for their restaurants" ON public.restaurant_tables;
...
DROP POLICY IF EXISTS "Users can view scans for their restaurants" ON public.qr_scans;
...
DROP POLICY IF EXISTS "Users can view subscription orders for their restaurants" ON public.subscription_orders;
DROP POLICY IF EXISTS "Users can create subscription orders for their restaurants" ON public.subscription_orders;
...
DROP POLICY IF EXISTS "Users can view payments for their restaurants" ON public.subscription_payments;
